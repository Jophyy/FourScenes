...
public class S1 : SEScene
{
    ...
    public void initialize(SEResourceCache rsc) {
        ...
        mincolor2=add_sprite_for_color(Color.instance("blue"), get_scene_width()*0.12, get_scene_height()*0.07);
        ...
        mincolor3=add_sprite_for_color(Color.instance("green"), get_scene_width()*0.12, get_scene_height()*0.07);
